    ...
    return(
        <div className="group relative flex cursor-pointer">
            <motion.div
                ...
                <Image src='/pic.jpg' width={100} height={100} alt="logo" className="rounded-full border-gray-500 object-cover w-16 h-16 xl:w-24 xl:h-24 filter group-hover:grayscale transition duration-300 ease-in-out"/>
            </motion.div>
